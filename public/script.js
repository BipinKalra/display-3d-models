...
const stopButton = document.querySelector("#stop-feed");
stopButton.addEventListener("click", () => {
  if (stopButton.innerHTML === "Stop Feed") {
    webcam.stop();
    stopButton.innerHTML = "Start Feed";
  } else {
    webcam
      .start()
      .then((result) => {
    ...
    stopButton.innerHTML = "Stop Feed";
  }
});

const toggleButton = document.querySelector("#toggle-feed");
...
let currentModelNumber = 1;
const prevButton = document.querySelector("#prev-button");
const nextButton = document.querySelector("#next-button");

document
  .querySelector(`#model${currentModelNumber}`)
  .setAttribute("visible", "true");

prevButton.addEventListener("click", () => {
  if (currentModelNumber === 1) currentModelNumber = 5;
  else currentModelNumber--;
...
nextButton.addEventListener("click", () => {
  if (currentModelNumber === 5) currentModelNumber = 1;
  else currentModelNumber++;
